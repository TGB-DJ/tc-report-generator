...
const LoadingOverlay = () => (
    <motion.div
        ...
        className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white/40 dark:bg-black/60"
    >
        <motion.div
            animate={{ 
                scale: [1, 1.1, 1],
            ...
            className="w-16 h-16 border-4 border-brand-blue border-t-transparent rounded-full shadow-[0_0_15px_rgba(37,99,235,0.5)]"
        />
        <motion.p
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className="mt-6 text-lg font-semibold text-slate-800 dark:text-white drop-shadow-md"
        >
...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-blue-50 dark:from-black dark:to-[#0a0a0a] p-4">
            <AnimatePresence>
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-colors font-medium disabled:opacity-50"
                            >
